...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None, defaultSaveDir=None):
        ...
        close = action(getStr('closeCur'), self.closeFile, None, 'close', getStr('closeCurDetail'))
        ...
        editMode = action('&Edit\nRectBox', self.setEditMode,
                          'Ctrl+W', 'edit', u'Move and edit Boxs', enabled=False)
        ...
        advancedMode = action(getStr('advancedMode'), self.toggleAdvancedMode,
                              None, 'expert', getStr('advancedModeDetail'),
                              checkable=True)
        ...
        aboutThis = action(getStr('info'), self.about, None, 'help', getStr('info'))
        ...
        filesview = self.filedock.toggleViewAction()
        filesview.setText(getStr('showHideFiles'))
        ...
        addActions(self.menus.file,
                   (open, opendir, changeSavedir, openAnnotation, self.menus.recentFiles, save, saveAs, close, quit))
        ...
        addActions(self.menus.windows, (
            self.viewToolbar,
            labels,
            filesview))

        addActions(self.menus.configs, (
            self.autoSaving,
    ...
    def about(self):
        subprocess.Popen(self.screencastViewer + [self.website])
