...
required_packages.append('labelImgPlus')
...
setup(
    ...
    description="LabelImgPlus is only for personal learning,based on project LabelImg-1.8.2",
    long_description=readme + '\n\n' + history,
    author="HuFBH",
    author_email='email is not necessary',
    url='waitting',
    python_requires=REQUIRES_PYTHON,
    package_dir={'labelImgPlus': '.'},
    packages=required_packages,
    entry_points={
        'console_scripts': [
            'labelImgPlus=labelImgPlus.labelImgPlus:main'
        ]
    },
